...
A TypeScript client library for the [Internet Archive](https://archive.org) public API.
...
Documentation can be found [here](https://github.com/jzills/internet-archive-api/blob/main/README.md).
